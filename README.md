...
```java
Picasso.with(context).load("https://tango.agency/images/hello.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("https://tango.agency/images/hello.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "https://tango.agency/images/hello.jpg", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "https://tango.agency/images/hello.jpg",
